...
static const uint8_t _hidReportDescriptor[] PROGMEM = {
    ...
    0x29, 0x04,                    /*     USAGE_MAXIMUM (Button 4) changed to 15*/ 
...
#define iivxByte 7 		// should be equivalent to sizeof(JoyState_t)
...
void iivx_::setState(iivxReport_t *report)
{
  ...
  data[5] = report->rxAxis;    // Y axis
  data[6] = report->ryAxis;    // Z axis
